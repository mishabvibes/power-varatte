...
// Canvas Container Component (unchanged)
...
export default function CreateFramePage() {
  ...
  return (
    <div className="p-4 space-y-6 max-w-6xl mx-auto">
      <div className="mb-6">
        <div className="flex justify-between items-center p-4  bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-md">
          ...
          <Link
            ...
            className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 flex items-center text-gray-700 dark:text-gray-200 transition-colors"
          >
      ...
      <div className="bg-white/10 p-4 backdrop-blur-md rounded-lg border dark:border-white/20 shadow-md overflow-hidden">
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 text-gray-900 dark:text-gray-25 bg-white/10 backdrop-blur-md rounded-lg border dark:border-white/20 border-gray-600/20 ${
                  errors.name
                    ? "border-red-500"
                  ...
                  <div
                    className={` border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center ${
                      errors.frameImage
                        ...
                        : "border-gray-300 dark:border-gray-600 hover:border-blue-400 hover:bg-blue-50 dark:hover:border-blue-500 dark:hover:bg-blue-900/10"

...
export default function YatheemSponsorshipPage() {
  ...
  const handleFormSubmit = async (sponsorData: Partial<Sponsorship>) => {
    try {
      // Ensure type is set to Yatheem
      sponsorData.type = "Sponsor-Yatheem";
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {/* Header component */}
      <AdminHeader
        title="Yatheem Sponsorship Management"
        description="Manage Yatheem program sponsorships and track contributions"
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg p-4">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">6 Months</p>
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
                {isLoading ? (
                  <div className="h-8 w-16 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                ) : (
